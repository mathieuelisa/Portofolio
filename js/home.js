...
let app = {
  ...
  mouseCursor: () => {
    document.addEventListener("mousemove", (event1) => {
      ...
      app.cursor.style.top = yAxe - 15 + "px";
      app.cursor.style.left = xAxe - 15 + "px";
    });
    // document.addEventListener("mousemove", (event2) => {
    //   let x = event2.pageX;
    //   let b = event2.pageY;
    //   app.cursorCenter.style.top = b - 3 + "px";
    //   app.cursorCenter.style.left = x - 3 + "px";
    // });
    document.addEventListener("mousemove", (event3) => {
      let x = event3.pageX;
      let y = event3.pageY;
      app.textCursor.style.top = y - 75 + "px";
      app.textCursor.style.left = x - 5 + "px";
    });
  },
  animationOnMail: () => {
  ...
  gsapAnimation: function () {
    ...
    //   myMail,
    //   3,
    //   { opacity: 0, scrollTrigger: myMail, y: -60 },
    //   { opacity: 1, scrollTrigger: myMail, y: 00 }
    // );
    // gsap.fromTo(
    //   folio,
    //   5,
    //   { scrollTrigger: folio, opacity: 0 },
    //   { scrollTrigger: folio, opacity: 1 }
    // );
  },
